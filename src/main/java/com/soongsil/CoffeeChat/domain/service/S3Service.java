...
public class S3Service {
    ...
    public String saveFile(String directory, String username, MultipartFile multipartFile)
            throws IOException {
        // Long userId = getUserId(email);
        String timeStamp = new SimpleDateFormat("yyyyMMddHHmmssSSS").format(new Date());
        // String originalFilename = directory + "/" + username + "/" + timeStamp + "_" +
    ...
    public void deleteFrameImage(String username, String url) {
        ...
        amazonS3.deleteObject(
                new DeleteObjectRequest(bucket, "frame/" + username + "/" + originalFilename));
    }
    ...
    private static String extractFilenameFromS3Url(String s3Url) {
        try {
            ...
            return java.net.URLDecoder.decode(
                    pathComponents[pathComponents.length - 1], StandardCharsets.UTF_8.name());
        } catch (Exception e) {
